...
const (
	KVService_Get_FullMethodName    = "/parallax.kv.KVService/Get"
	KVService_Put_FullMethodName    = "/parallax.kv.KVService/Put"
	KVService_Delete_FullMethodName = "/parallax.kv.KVService/Delete"
	KVService_Cas_FullMethodName    = "/parallax.kv.KVService/Cas"
)
...
func (c *kVServiceClient) Cas(ctx context.Context, in *CasRequest, opts ...grpc.CallOption) (*CasResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CasResponse)
	err := c.cc.Invoke(ctx, KVService_Cas_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedKVServiceServer) Cas(context.Context, *CasRequest) (*CasResponse, error) {
...
func _KVService_Cas_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CasRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KVServiceServer).Cas(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KVService_Cas_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KVServiceServer).Cas(ctx, req.(*CasRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var KVService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "parallax.kv.KVService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Cas",
			Handler:    _KVService_Cas_Handler,
		},
	},
